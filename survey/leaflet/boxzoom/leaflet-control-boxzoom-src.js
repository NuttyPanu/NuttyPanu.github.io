...
L.Control.BoxZoom = L.Control.extend({
    options: {
        position: 'topright',
        title: 'คลิกแล้ววาดรูปสี่เหลี่ยมเพื่อซูมแผนที่',
        aspectRatio: null,
        divClasses: '',
...
$(function(){
    ...
    $('div.leaflet-control-boxzoom.with-background-image.leaflet-control').click(function(){
        //clear draw map
            //alert('click');
