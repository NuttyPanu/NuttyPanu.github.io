...
L.EdgeScaleBar = L.Layer.extend({
    ...
    options: {
        ...
        font: '11px Arial',
        zoomInterval: [
            {start: 1, end: 1, interval: 5000000},
            {start: 2, end: 2, interval: 2000000},            
            {start: 3, end: 3, interval: 1000000},
            {start: 4, end: 4, interval: 500000},
            {start: 5, end: 5, interval: 300000},
            {start: 6, end: 6, interval: 200000},
            {start: 7, end: 7, interval: 100000},            
            {start: 8, end: 8, interval: 50000},
            {start: 9, end: 9, interval: 20000},
            {start: 10, end: 10, interval: 10000},
            {start: 11, end: 11, interval: 5000},
            {start: 12, end: 12, interval: 3000},
            {start: 13, end: 13, interval: 1000},
            {start: 14, end: 14, interval: 500},
            {start: 15, end: 15, interval: 300},
    ...
    _calcInterval: function() {
        ...
        //console.log(this.options.zoomInterval);
