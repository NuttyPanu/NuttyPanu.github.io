...
L.EdgeScaleBar = L.Layer.extend({
    ...
    options: {
        ...
        zoomInterval: [
            ...
            {start: 2, end: 3, interval: 2000000},            
            {start: 3, end: 4, interval: 1000000},
            {start: 4, end: 4, interval: 500000},
            */
            {start: 5.00, end: 5.50, interval: 300000},
            {start: 5.75, end: 6.00, interval: 200000},
            {start: 6.25, end: 7.00, interval: 100000},            
            {start: 7.25, end: 8.00, interval: 50000},
            {start: 8.25, end: 8.75, interval: 30000},            
            {start: 9.00, end: 9.50, interval: 20000},
            {start: 9.75, end: 10.50, interval: 10000},
            {start: 10.75, end: 11.50, interval: 5000},
            {start: 11.75, end: 12.75, interval: 3000},
            {start: 13.00, end: 13.75, interval: 1000},
            {start: 14.00, end: 14.75, interval: 500},
            {start: 15.00, end: 15.50, interval: 300},
            {start: 15.75, end: 16.00, interval: 200},
            {start: 16.25, end: 17.00, interval: 100},
            {start: 17.25, end: 18.00, interval: 50},
            {start: 18.25, end: 18.75, interval: 30},
            {start: 19.00, end: 19.25, interval: 20},
            {start: 19.50, end: 30.00, interval: 10}            
        ]
    },
    ...
    _calcInterval: function() {
        ...
        //console.log(zoom,this.options.zoomInterval);
        for (var idx in this.options.zoomInterval) {
            var dict = this.options.zoomInterval[idx];
            //console.log('dictzoom:'+dict.interval+','+'dictstart:'+dict.start+','+'zoom:'+zoom);
            if (dict.start <= zoom) {
    ...
    //console.log(this._dd);
	if (this._dd >= 1000) { units = ' km'; dd = this._dd/1000; }else{}
