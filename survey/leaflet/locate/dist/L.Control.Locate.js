    ...
    var LocateControl = L.Control.extend({
        options: {
            ...
            strings: {
                ...
                metersUnit: "meters",
                feetUnit: "feet",
                popup: "{latlng} <br> You are within {distance} {unit} from this point",
        ...
        _drawMarker: function() {
            ...
            function getPopupText() {
                if (typeof t === 'string') {
                    return L.Util.template(t, {latlng: latlng, distance: distance, unit: unit});
                } else if (typeof t === 'function') {
                    return t({latlng: latlng, distance: distance, unit: unit});
                } else {
                    return t;
                }
            }
